...
<body class=" flex items-center justify-center w-full p-5 h-full bg-no-repeat" style=" background-image: url('./src/img/bg.png'); background-size: cover; background-position: center;">
    <div class="flex flex-col bg-[#004225] p-[2rem] w-[90%] md:w-[30%] rounded-xl min-w-[30rem]">
        ...
        <form action="" class="text-white flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-5 items-center pt-5 justify-center">
                <a href="./login" class="hover:text-green-400">Already have an account ? Login</a>
                <a href="#" class="bg-green-500 text-white font-bold rounded-lg block w-full p-3 text-center hover:bg-green-800 transition">SignUp</a>
            </div>
        </form>
    </div>
